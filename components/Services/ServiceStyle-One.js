...
const ServiceStyleOne = ({serviceOne, buttonText}) => {
  const { isLightTheme } = useAppContext();

  console.log(`serviceOne => ${JSON.stringify(serviceOne)}`)
                    ...
                    <div className="rainbow-box-card card-style-default aiwave-service-default has-bg-shaped">
                      <div className="inner">
                        ...
                        <div className="description centered-shape">
                          <h5 className="title">{serviceOne[index].title}</h5>
                          <p className="desc">{serviceOne[index].desc}</p>
                          {/*
